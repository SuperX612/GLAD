...
def construct_dataloaders(dataset, defs, data_path='~/data', shuffle=True, normalize=True):
    ...
    if dataset == 'CIFAR10':
        ...
        trainset, validset = datasets.ImageFolder('/home/b1107/user/xkl/Database/ilsvrc2012/train', transform=transform), datasets.ImageFolder('/home/b1107/user/xkl/Database/ilsvrc2012/val', transform=transform)
        loss_fn = Classification()
...
def _build_imagenet(data_path, augmentations=True, normalize=True):
    ...
    trainset = torchvision.datasets.ImageFolder(root = data_path + "/train",transform = data_transform)
    validset = torchvision.datasets.ImageFolder(root = data_path + "/val",transform = data_transform)
